<%@ Page Title="" Language="C#" MasterPageFile="~/Painel/Painel.master" AutoEventWireup="true" CodeFile="Legislacao.aspx.cs" Inherits="Painel_Modulos_Legislacao" %>
        ...
        <div class="row">
            <div class="col-md-12 col-xl-12">
                <div id="panel-1" class="panel">
                    <div class="panel-hdr">
                        <h2>Publicações<span class="fw-300"><i></i></span></h2>
                    </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        ...
                                        <asp:GridView ID="gvLegislacao" runat="server" AutoGenerateColumns="False"
                                            ...
                                            DataKeyNames="WebLegislacaoID" OnRowCommand="gvCategoria_RowCommand">
                                            <Columns>
                                                <asp:BoundField DataField="WebLegislacaoID" HeaderText="WebLegislacaoCatID">
                                                ...
                                                <asp:TemplateField HeaderText="Opções">
                                                    <ItemTemplate>
                                                        ...
                                                        <asp:LinkButton ID="lnkEditar" runat="server" class="btn btn-outline-success btn-xs btn-icon waves-effect waves-themed" CausesValidation="false"
                                                            CommandName="Editar" Text="Editar" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "WebLegislacaoID")%>'><i class="fal fa-check"></i>
                                                        </asp:LinkButton>
                                                        ...
                                                        <asp:LinkButton ID="lnkDelete" runat="server" class="btn btn-outline-danger btn-xs btn-icon waves-effect waves-themed" CausesValidation="false"
                                                            CommandName="Excluir" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "WebLegislacaoID" ) %>'><i class="fal fa-times"></i></asp:LinkButton>
                                                        ...
                                                        <asp:LinkButton ID="lnkItens" runat="server" class="btn btn-outline-success btn-xs btn-icon waves-effect waves-themed" CausesValidation="false"
                                                            ...
                                                            CommandArgument='<%# DataBinder.Eval(Container.DataItem, "WebLegislacaoID")%>'><i class="fal fa-list-alt"></i></asp:LinkButton>
                                                    </ItemTemplate>
                                                    <ItemStyle />
                                                </asp:TemplateField>
                                            </Columns>
