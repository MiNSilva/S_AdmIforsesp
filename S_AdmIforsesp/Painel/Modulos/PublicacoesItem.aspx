<%@ Page Title="" Language="C#" MasterPageFile="~/Painel/Painel.master" AutoEventWireup="true" CodeFile="PublicacoesItem.aspx.cs" Inherits="Painel_Modulos_PublicacoesItem" %>
    ...
    <main id="js-page-content" role="main" class="page-content">
        <div class="subheader">
            <h1 class="subheader-title">
                <i class='subheader-icon fal fa-edit'></i>Publicações Iten(s)
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        ...
                                        <asp:GridView ID="gvLegislacaoItem" runat="server" AutoGenerateColumns="False"
                                            ...
                                            DataKeyNames="WebPublicacaoItemID" OnRowCommand="gvLegislacaoItem_RowCommand" AllowPaging="True"
                                            PageSize="10" OnPageIndexChanging="gvLegislacaoItem_PageIndexChanging">
                                            <Columns>
                                                <asp:BoundField DataField="WebPublicacaoItemID" HeaderText="WebPublicacaoItemID">
                                                ...
                                                <asp:TemplateField HeaderText="Arquivo">
                                                    <ItemTemplate>
                                                        <a href="<%# DataBinder.Eval(Container.DataItem, "arquivo","../../../Download/Publicacao/{0}")%>" target="_blank">
                                                ...
                                                <asp:TemplateField HeaderText="Ordenação">
                                                    <ItemTemplate>
                                                        <asp:LinkButton ID="lnkSubirr" runat="server" CommandName="Subir"
                                                            ...
                                                            CommandArgument='<%# DataBinder.Eval(Container.DataItem, "WebPublicacaoItemID")%>'>
                                                ...
                                                <asp:TemplateField HeaderText="Opções">
                                                    <ItemTemplate>
                                                        <asp:LinkButton ID="lnkEditar" runat="server" class="btn btn-outline-success btn-xs btn-icon waves-effect waves-themed" CausesValidation="false"
                                                            CommandName="Editar" Text="Editar" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "WebPublicacaoItemID")%>'><i class="fal fa-check"></i>
                                                        </asp:LinkButton>
                                                        ...
                                                        <asp:LinkButton ID="lnkDelete" runat="server" class="btn btn-outline-danger btn-xs btn-icon waves-effect waves-themed" CausesValidation="false"
                                                            CommandName="Excluir" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "WebPublicacaoItemID" ) %>'><i class="fal fa-times"></i></asp:LinkButton>
                                                    </ItemTemplate>
                                                    <ItemStyle />
                                                </asp:TemplateField>
                                            </Columns>
