<%@ Page Title="" Language="C#" MasterPageFile="~/Painel/Painel.master" AutoEventWireup="true" CodeFile="PublicacoesEdita.aspx.cs" Inherits="Painel_Modulos_PublicacoesEdita" %>
        ...
        <div class="row">
            <div class="col-md-12 col-xl-12">
                <div id="panel-1" class="panel">
                    <div class="panel-hdr">
                        <h2>Publicações Categoria<span class="fw-300"><i>Inserção | Edição</i></span></h2>
                    </div>
                    <div class="panel-container show">
                        <div class="panel-content">
                            <div class="panel-tag">
                                Informar o nome da Categoria da Publicação para Inclusão | Alteração.
                            </div>
                            <div class="row">
                                <h5>
