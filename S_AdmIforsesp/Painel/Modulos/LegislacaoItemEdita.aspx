<%@ Page Title="" Language="C#" MasterPageFile="~/Painel/Painel.master" AutoEventWireup="true" CodeFile="LegislacaoItemEdita.aspx.cs" Inherits="Painel_Modulos_LegislacaoItemEdita" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <main id="js-page-content" role="main" class="page-content">
        <div class="subheader">
            <h1 class="subheader-title">
                <i class='subheader-icon fal fa-edit'></i>Legislação Item
        ...
        <div class="row">
            <div class="col-md-12 col-xl-12">
                <div id="panel-1" class="panel">
                    <div class="panel-hdr">
                        <h2>Legislação Item <span class="fw-300"><i>Inserção | Edição</i></span></h2>
                    </div>
                    <div class="panel-container show">
                        ...
                        <div class="panel-content">
                            <div class="panel-tag">
                                Informar a descrição da Item (Legislação) para Inclusão | Alteração.
                            </div>
                            <div class="row">
