<%@ Page Title="" Language="C#" MasterPageFile="~/Painel/Painel.master" AutoEventWireup="true" CodeFile="Utilidades.aspx.cs" Inherits="Painel_Modulos_Utilidades" %>
        ...
        <div class="row">
            <div class="col-md-12 col-xl-12">
                <div id="panel-1" class="panel">
                    <div class="panel-hdr">
                        <h2>Utilidades<span class="fw-300"><i></i></span></h2>
                    </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        ...
                                        <asp:GridView ID="gvUtilidade" runat="server" AutoGenerateColumns="False"
                                            DataKeyNames="WebUtilidadeID" OnRowCommand="gvUtilidade_RowCommand"
                                            AllowPaging="True" PageSize="10"
                                            CssClass="table table-striped table-bordered table-hover"
                                            OnPageIndexChanging="gvUtilidade_PageIndexChanging">
                                            <Columns>
                                                <asp:BoundField DataField="WebUtilidadeID" HeaderText="WebUtilidadeID">
                                                ...
                                                <asp:TemplateField HeaderText="Ordenação">
                                                    <ItemTemplate>
                                                        <asp:LinkButton ID="lnkSubirr" runat="server" CommandName="Subir"
                                                            ...
                                                            CommandArgument='<%# DataBinder.Eval(Container.DataItem, "WebUtilidadeID")%>'>
                                                ...
                                                <asp:TemplateField HeaderText="Opções">
                                                    <ItemTemplate>
                                                          <asp:LinkButton ID="lnkEditar" runat="server" class="btn btn-outline-success btn-xs btn-icon waves-effect waves-themed" CausesValidation="false"
                                                            CommandName="Editar" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "WebUtilidadeID" ) %>'><i class="fal fa-check"></i></asp:LinkButton>
                                                        ...
                                                        <asp:LinkButton ID="lnkDelete" runat="server" class="btn btn-outline-danger btn-xs btn-icon waves-effect waves-themed" CausesValidation="false"
                                                            CommandName="Excluir" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "WebUtilidadeID" ) %>'><i class="fal fa-times"></i></asp:LinkButton>
                                                       </ItemTemplate>
                                                    <ItemStyle />
                                                </asp:TemplateField>
                                            ...
                                            <EmptyDataTemplate>
                                                <span class="pro_info pro_info_important">Não há Utilidade(s)</span>
                                            </EmptyDataTemplate>
                                        </asp:GridView>
